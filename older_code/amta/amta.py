...
from .tokenizers import VowelTokenizer
from .triple import AugmentedTranslationModel
from .triple_fi import AugmentedTranslationModel2
from subword_bpe.learn_bpe import main as learn_bpe
from subword_bpe.apply_bpe import BPE


class SubwordModel(MonolingualSubWordModel):
    tokenizer_cls = VowelTokenizer


class AugmentedSubWordTranslationModel(AugmentedTranslationModel):
    submodel_cls = SubwordModel
